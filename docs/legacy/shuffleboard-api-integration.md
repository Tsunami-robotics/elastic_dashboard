...
{% hint style="warning" %}
Support for the Shuffleboard API has been removed in favor of downloading full layouts from the robot, see the [migration guide](shuffleboard-api-migration.md) for more information
{% endhint %}
